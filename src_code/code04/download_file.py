...
""" 
No script anterior entendemos sobre o requests TIMEOUT utilizando
o auxílio do site https://httpbin.org/.

Agora vamos aplicar em um caso real para baixar um arquivo .zip 
e descompactá-lo.

Path(__file__) = diretorio deste arquivo
